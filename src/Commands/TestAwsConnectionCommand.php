...
class TestAwsConnectionCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        if ($key && !preg_match('/^AKIA[A-Z0-9]{16}$/', $key)) {
            ...
            $this->line('   AWS_SECRET_ACCESS_KEY=rhrz...');
            $this->line('');
        }
        ...
        if (!$key || !$secret) {
            ...
            $this->line('AWS_ACCESS_KEY_ID=your-key-here');
            $this->line('AWS_SECRET_ACCESS_KEY=your-secret-here');
        ...
        try {
            ...
            $this->line('  1. AWS_ACCESS_KEY_ID is incorrect');
            $this->line('  2. AWS_SECRET_ACCESS_KEY is incorrect');
